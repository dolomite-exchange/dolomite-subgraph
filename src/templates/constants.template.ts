...
export const BERACHAIN_BARTIO_NETWORK = 'berachain-bartio'
...
CHAIN_IDS.set(BERACHAIN_BARTIO_NETWORK, BigInt.fromI32(80084))
...
WHITELISTS.set(BERACHAIN_BARTIO_NETWORK, [])
